    ...
    return (
        <div className='flex items-center justify-center md:h-screen bg-[#ECF2FF]  '>
            <div className='md:flex md:max-w-[736px] bg-white md:rounded-3xl'>
                <div className='bg-linear-180 from-[#7755FF] from-0% to-[#2F2CE9] to-100% rounded-b-3xl md:rounded-3xl flex flex-col justify-center items-center flex-1'>
                    ...
                    <p className='text-[#CAC9FF] font-medium text-[16px] md:text-[18px] text-center px-[54px] pb-[40px] md:pb-[55px] '>You scored higher than 65% of the people who have taken these tests.</p>
                </div>
                <div className='flex-1 px-[30px] pt-[24px] pb-[30px] flex flex-col'>
